...
public class WorkoutListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button backButton = findViewById(R.id.back_button_workoutlist);
        ...
        String[][] workoutList = {
                ...
                {"덤벨숄더프레스 (Dumbbell Shoulder Press)",
                        ...
                        "주요 근육: 이두근, 삼두근, 견갑근, 삼각근",
                                "https://www.youtube.com/shorts/hcp5tnX89N0"},
                {"덤벨컬 (Dumbbell Curl)",
                ...
                {"레그익스텐션/컬 (Leg Extension/Leg Curl)",
                        ...
                        "주요 근육: 대퇴사두근, 대퇴이두근, 종아리근" ,
                                "https://www.youtube.com/shorts/MpdQ2S_G0J8"},
                {"폼롤러 상체운동 전후 (Foam Roller Myofascial Release)",
                        "자세: 폼롤러를 사용하여 몸의 근육을 압박하고 이완시키는 동작을 합니다. 특히 근육의 힘줄 부분을 중심으로 압박합니다. 통증이 있는 부위에 집중해서 사용합니다.",
                        "",
                        "https://www.youtube.com/watch?v=fJHvqtFDO9g"},
                {"폼롤러 하체운동 전후 (Foam Roller Myofascial Release)",
                        "자세: 폼롤러를 사용하여 몸의 근육을 압박하고 이완시키는 동작을 합니다. 특히 근육의 힘줄 부분을 중심으로 압박합니다. 통증이 있는 부위에 집중해서 사용합니다.",
                        "",
                        "https://www.youtube.com/watch?v=z6fH7v5dBIM"},
                ...
                {"벤트오버 바벨로우 (Bent-Over Barbell Row)",
                        ...
                        "주요 근육: 넓적다리근, 중후면근, 이두근" ,
                                "https://www.youtube.com/shorts/M29okCSNjsc"},
                ...
                {"시티드 로우 (Seated Row)",
                        ...
                        "주요 근육: 중후면근, 이두근" ,
                                "https://www.youtube.com/shorts/t6edD5c7QWw"},
                {"플랭크 (Plank)",
                ...
                {"런지 (Lunge)",
                        ...
                        "주요 근육: 대퇴사두근, 대둔근, 종아리근" ,
                                "https://www.youtube.com/shorts/OvGSczSOcaY"},
                {"레그컬 (Leg Curl)",
                        "자세: 레그컬 머신에 앉아 다리를 펴고 다시 굽히는 동작을 반복합니다. 종아리 근육을 강화하는 운동입니다.",
                        "주요 근육: 종아리근" ,
                                "https://www.youtube.com/shorts/r1D5vlnzOVU"},
                {"크런치 (Crunch)",
                ...
                {"벤치프레스 (Bench Press)",
                        ...
                        "주요 근육: 대흉근, 삼두근, 이두근" ,
                                "https://www.youtube.com/shorts/ub936ioAT9o"},
                {"딥스 (Dips)",
                ...
                {"바이셉 컬 (Bicep Curl)",
                        ...
                        "주요 근육: 이두근" ,
                                "https://www.youtube.com/shorts/TJmc476epeg"},
                {"풀업 (Pull-up)",
                        "자세: 철봉에 매달려 손바닥이 자신을 향하도록 손을 벌리고 철봉을 잡습니다. 팔의 힘으로 철봉을 당겨 목 뒤로 올라갑니다. 팔을 최대한 굽히고 다시 원위치로 돌아옵니다.",
                        "주요 근육: 넓적다리근, 대흉근, 이두근",
                ""},
                ...
                {"사이드 레터럴 레이즈 (Side Lateral Raise)",
                        ...
                        "주요 근육: 삼각근, 견갑근" ,
                                "https://www.youtube.com/shorts/1HhMAvo9zTg"},
                ...
                {"스쿼트 (Squat)",
                        ...
                        "주요 근육: 대퇴사두근, 대둔근, 종아리근" ,
                                "https://www.youtube.com/shorts/RGb4Di4Dk_k"},
        ...
        for (String[] workout : workoutList) {
           // String workout_Text = workout[2].substring(0, workout[2].indexOf("https://"));
            //String youtube_Link = workout[2].substring(workout[2].indexOf("https://"));
            createWorkoutView(workout[0], workout[1], workout[2],workout[3]);
        }
    }

    private void createWorkoutView(String namew, String descriptionw, String workout_muscle, String youtube_Link) {
        @SuppressLint("InflateParams") View workoutView = LayoutInflater.from(this).inflate(R.layout.item_workout, null);
        ...
        TextView youtube_LinkTextView = workoutView.findViewById(R.id.youtube_link_text_view);


        namewTextView.setText(namew);
        descriptionwTextView.setText(descriptionw);
        workout_muscleTextView.setText(workout_muscle);
        youtube_LinkTextView.setText(youtube_Link);

        youtube_LinkTextView.setMovementMethod(LinkMovementMethod.getInstance());
        youtube_LinkTextView.setOnClickListener(v -> {
